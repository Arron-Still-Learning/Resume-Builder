        ...
        <div class="inner-edit">
            ...
            <form class="form-edit-resume" action="{{ route('user.resume.store') }}" method="POST"
                    ...
                    <div class="one-row">
                        ...
                        <div>
                            <div class="upload-profile-photo">
                                <img id="profilePhoto" src="{{ asset('images/upload_resume_photo.png') }}"
                            ...
                            <div class="one-row">
                                <div>
                                    ...
                                    <input type="text" id="skill_name" name="skill_name[]"
                                        class="input-edit-resume" value="{{ old('skill_name.0') }}">
                                    @error('skill_name.*')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <select id="skill_level" name="skill_level[]" class="select-edit-resume">
                                        <option value="Beginner"
                                            {{ old('skill_level.0') == 'Beginner' ? 'selected' : '' }}>Beginner
                                        </option>
                                        <option value="Intermediate"
                                            {{ old('skill_level.0') == 'Intermediate' ? 'selected' : '' }}>
                                            Intermediate
                                        </option>
                                        <option value="Advanced"
                                            {{ old('skill_level.0') == 'Advanced' ? 'selected' : '' }}>Advanced
                                        </option>
                                        <option value="Expert"
                                            {{ old('skill_level.0') == 'Expert' ? 'selected' : '' }}>
                                            Expert</option>
                                        <option value="Master"
                                            {{ old('skill_level.0') == 'Master' ? 'selected' : '' }}>
                                            Master</option>
                                    </select>
                                </div>
                            </div>
                ...
                <section class="education_set">
                            ...
                            <div class="one-row">
                                <div>
                                    ...
                                    <input type="text" id="institution" name="institution[]"
                                        class="input-edit-resume" value="{{ old('institution.0') }}">
                                    @error('institution.*')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="date-fields-edit-resume">
                                <div>
                                    ...
                                    <input type="date" id="start_date_education" name="start_date_education[]"
                                        class="input-edit-resume" value="{{ old('start_date_education.0') }}">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="end_date_education" name="end_date_education[]"
                                        class="input-edit-resume" value="{{ old('end_date_education.0') }}">
                    ...
                    <div class="add-sec-copy">
                        <button type="button" class="button-edit-resume add_section_btn"
                            data-section="education">Add
                            Education</button>
                    </div>
                </section>
                            ...
                            <div class="one-row">
                                <div>
                                    ...
                                    <input type="text" id="language_name" name="language_name[]"
                                        class="input-edit-resume" value="{{ old('language_name.0') }}">
                                    @error('language_name.*')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <select id="proficiency" name="proficiency[]" class="select-edit-resume">
                                        <option value="Beginner"
                                            {{ old('proficiency.0') == 'Beginner' ? 'selected' : '' }}>Beginner
                                        </option>
                                        <option value="Intermediate"
                                            {{ old('proficiency.0') == 'Intermediate' ? 'selected' : '' }}>
                                            Intermediate
                                        </option>
                                        <option value="Advanced"
                                            {{ old('proficiency.0') == 'Advanced' ? 'selected' : '' }}>Advanced
                                        </option>
                                        <option value="Fluent"
                                            {{ old('proficiency.0') == 'Fluent' ? 'selected' : '' }}>
                                            Fluent</option>
                                        <option value="Native"
                                            {{ old('proficiency.0') == 'Native' ? 'selected' : '' }}>
                                            Native</option>
                                    </select>
                ...
                <section class="exp_set">
                    <fieldset class="fieldset-edit-resume" id="experiences_fieldset">
                        ...
                        <div class="experience-entry-edit-resume" id="experience_section_1">
                            <div class="one-row">
                                <div>
                            ...
                            <div class="date-fields-edit-resume">
                                <div>
                                    ...
                                    <input type="date" id="start_date_experience" name="start_date_experience[]"
                                        class="input-edit-resume" value="{{ old('start_date_experience.0') }}">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="end_date_experience" name="end_date_experience[]"
                                        class="input-edit-resume" value="{{ old('end_date_experience.0') }}">
                            ...
                            <textarea id="description_experience" name="description_experience[]" class="textarea-edit-resume">{{ old('description_experience.0') }}</textarea>
                ...
                <section class="project_set">
                    <fieldset class="fieldset-edit-resume" id="projects_fieldset">
                        ...
                        <div class="project-entry-edit-resume" id="project_section_1">
                            <div>
                                <label class="label-edit-resume" for="project_name">Project Name:</label>
                                <input type="text" id="project_name" name="project_name[]"
                                    class="input-edit-resume" value="{{ old('project_name.0') }}">
                                @error('project_name.*')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            <label class="label-edit-resume" for="description_project">Description:</label>
                            <textarea id="description_project" name="description_project[]" class="textarea-edit-resume">{{ old('description_project.0') }}</textarea>
                ...
                <div class="buttons-edit-resume">
                    <a href="{{ route('user.list') }}">
                        <button type="button" class="button-edit-resume btn-resume-save" id="back_button">
                            Back
                        </button>
                    </a>
