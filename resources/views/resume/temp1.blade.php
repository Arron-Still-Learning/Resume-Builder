...
<body>
    <div class="button-container">
        ...
        <div class="">
            <a href="{{ route('user.resume.generatepdf', 1) }}" class="change-button">Download</a>
        </div>
    </div>
    <main class="main-content">
        <section class="left-section">
            ...
            <div class="personal-info">
                ...
                <ul>
                    <li>
                        <img class="personal-logo" src="{{ asset('images/calendar-white.webp') }}" alt="Description of Image" >
                        {{-- <i class="fa fa-calendar"></i> --}}
                        Date of Birth: {{ $personalDetail->date_of_birth }}
                    </li>
                    <li>
                        <img class="personal-logo" src="{{ asset('images/location.png') }}" alt="Description of Image" >
                        {{-- <i class="fa fa-map-marker"></i> --}}
                        Address: {{ $personalDetail->address }}
                    </li>
                    <li>
                        <img class="personal-logo" src="{{ asset('images/email-white.png') }}" alt="Description of Image" >
                        {{-- <i class="fa fa-envelope"></i> --}}
                        Email: {{ $personalDetail->email }}
                    </li>
                    <li>
                        <img class="personal-logo" src="{{ asset('images/phone-white.jpg') }}" alt="Description of Image" >
