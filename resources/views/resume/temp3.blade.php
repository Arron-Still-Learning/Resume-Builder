...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/template3.css') }}">
...
<body>
    <div class="button-container">
        ...
        <div class="">
            <a href="{{ route('user.resume.generatepdf', 3) }}" class="change-button">Download</a>
        </div>
    </div>
    <main class="main-content">
        <section class="left-section">
            <div class="profile">
                <div class="image">
                    <img src="{{ asset('images/resume1.webp') }}" alt="Resume Photo">
                </div>
